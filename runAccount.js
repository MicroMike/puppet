...
socket.on('streams', a => {
  ...
  shell.exec(`google-chrome-stable --cast-initial-screen-width=800,600 --no-sandbox --disable-setuid-sandbox --user-data-dir="save/' + player + '_' + login + '" --no-first-run --remote-debugging-port=` + port, { silent: true }, () => { })
