module.exports = async (socket, page, parentId, streamId, check, account) => {
	return new Promise(async (r) => {
		...
		const exit = async (e) => {
			...
			catch (e) { console.log('exit', login, e) }
		...
		try {
			...
			await shell.exec('"C:/Program Files (x86)/Google/Chrome/Application/chrome.exe" --mute-audio --disable-features=Translate --no-first-run --user-data-dir="C:/Users/Mike/workspace/puppet/saveCookie/' + login + '" --remote-debugging-port=' + port, { async: true, silent: true })
